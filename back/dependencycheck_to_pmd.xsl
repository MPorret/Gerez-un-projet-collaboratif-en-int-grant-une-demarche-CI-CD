...
<xsl:stylesheet version="1.0"
    ...
    xmlns:b="https://jeremylong.github.io/DependencyCheck/dependency-check.2.5.xsd"
    xmlns:a="http://pmd.sourceforge.net/report/2.0.0" exclude-result-prefixes="b">
    <xsl:param name="currentTimestamp"/>

    <xsl:template match="/">
        <a:pmd xmlns="http://pmd.sourceforge.net/report/2.0.0"
            xmlns:xsi="http://www.w3.org/2001/XMLSchema-instance" xsi:schemaLocation="http://pmd.sourceforge.net/report/2.0.0 http://pmd.sourceforge.net/report_2_0_0.xsd" version="6.29.0">
